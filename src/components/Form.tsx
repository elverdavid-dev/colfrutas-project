...
const Form = () => {
  return (
    <ThemeProvider>
        <h2 className='text-center font-lora text-2xl text-emerald-600 mb-16'>O atra vez de este formulario</h2>
        ...
        <form  className='lg:w-[400px] w-full space-y-8   mx-auto mb-40 '>
            ...
            <Button variant='gradient' title='enviar formulario'  color='teal' fullWidth>enviar</Button>
        </form>
