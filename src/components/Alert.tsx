		...
		>
			<div className="flex items-cente justify-start gap-x-2">
				...
				<span className="flex-1 font-rubik text-lg">
					Es importante señalar que esta página no es oficial de la compañía,
					sino que fue creada para poner en práctica conocimientos y habilidades
					en el desarrollo web.Mas sobre mi en la parte inferior de esta pagina,
					La página oficial de Colfrutas es
					<a
